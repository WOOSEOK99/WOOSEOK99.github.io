...
<br>
<img src="10.jpg" alt="장소 검색 및 구글지도로 위치 검색" width="50%">


**2. 똑똑한 자동 시간 체이닝**
* 체류 시간만 입력하세요. 다음 일정의 도착 시간을 앱이 알아서 계산해 드립니다. 일정 변경 시 전체 타임라인이 자동으로 업데이트되어 계획이 훨씬 쉬워집니다.
<br>
<img src="2.png" alt="기능 2 - 일정 입력 및 시간 설정" width="45%"> <img src="3.png" alt="기능 2 - 자동 연동된 타임라인 화면" width="45%">
...
<br>
<img src="7.png" alt="기능 4 - 가계부 및 비용 관리" width="45%"> <img src="6.png" alt="기능 4 - 짐 싸기 체크리스트" width="45%">
